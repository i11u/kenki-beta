...
const TextHighlight = () => {
  ...
  const [colors, setColors] = useState(['yellow', 'pink', 'skyblue'])
  ...
  return (
    <div className="toolset-text-tools-item">
      ...
      <div className="toolset-text-tools-item-content">
        ...
        >
          <div
            className="toolset-text-tools-item-color-palette-color"
            style={{ backgroundColor: `${colors[0]}`, opacity: '0.6' }}
          />
          <div
            className="toolset-text-tools-item-color-palette-color"
            style={{ backgroundColor: `${colors[1]}`, opacity: '0.6' }}
          />
          <div
            className="toolset-text-tools-item-color-palette-color"
            style={{ backgroundColor: `${colors[2]}`, opacity: '0.6' }}
          />
        </div>
      </div>
    </div>
