...
const TextToolsOptional = () => {
  ...
  return (
    <div className="toolset-text-tools-optional">
      ...
      >
        {mode === 'SELECT' ? 'press Escape to go back' : ' toolset 2 (release option/alt to switch toolsets) '}
      </div>
      <div
        ...
        <div className="toolset-text-tools-optional-item">
          ...
          <div className="toolset-text-tools-optional-item-content">
            ...
            >
              ...
              <code
                style={{
                  color: colorTheme.codeColor,
                  backgroundColor: colorTheme.codeBackground,
                }}
              >
                hjkl
              </code>
              <br />
              faster{' '}
              <code style={{ color: colorTheme.codeColor, backgroundColor: colorTheme.codeBackground }}>
                shift + hjkl
              </code>
            </div>
          </div>
        ...
        <div className="toolset-text-tools-optional-item">
          ...
          <div className="toolset-text-tools-optional-item-content">
            ...
            >
              ...
              <br />
              anti-clockwise{' '}
              <code style={{ color: colorTheme.codeColor, backgroundColor: colorTheme.codeBackground }}>ctrl + r</code>
            </div>
          </div>
        </div>
        {/* <div className="toolset-text-tools-optional-item disabled"> */}
        {/*  <div */}
        {/*    className="toolset-text-tools-optional-item-title" */}
        {/*    style={{ */}
        {/*      color: `${colorTheme.text}`, */}
