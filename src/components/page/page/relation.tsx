...
const RelationTSX = ({ relationAtom }: { relationAtom: PrimitiveAtom<Relation> }) => {
  ...
  useLayoutEffect(() => {
    if (relation.type === 'normal') {
      ...
      svg2
        ...
        .attr('fill', colorTheme.editorBackground)
        .attr('d', d.join(' '))
  ...
  }, [colorTheme.editorBackground, colorTheme.text, endBlock, gridNum, relation, startBlock, x1, x2, y1, y2, scale])
      ...
      >
        {relation.type === 'normal' ? (
          <defs>
            ...
            >
              <path d="M 0 0 L 15 7.5 L 0 15 z" fill={colorTheme.text} />
            </marker>
          </defs>
        ) : null}
      </svg>
