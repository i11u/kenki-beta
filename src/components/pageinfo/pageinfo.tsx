...
const Pageinfo = ({ workingModuleIndex, pageinfoIsVisible, pageinfoWidth }: Props) => {
  ...
  useEffect(() => {
    if (pageinfoIsVisible) {
      document.getElementsByClassName('sidebar')[0].classList.remove('disabled')
    } else {
      document.getElementsByClassName('sidebar')[0].classList.add('disabled')
    }
  }, [pageinfoIsVisible])
    ...
    >
      ...
      <div className="pageinfo-item">
        <div className="pageinfo-item-icon-container">
          <svg id="_レイヤー_1" className="pageinfo-item-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
